  ...
  <SheetPortal>
    ...
    <SheetPrimitive.Content
      ...
      className={cn(
        ...
        side === "right" &&
          "inset-y-0 right-0 h-full w-full sm:w-[380px] border-l border-border data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right data-[state=closed]:animate-out data-[state=open]:animate-in",
        className
      )}
      {...props}
    >
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Title ref={ref} className={cn("eyebrow text-muted-foreground", className)} {...props} />
));
