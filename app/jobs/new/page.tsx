    ...
    try {
      const res = await fetch("/api/jobs", {
        ...
        body: JSON.stringify({
          ...
          type: result.job_type || undefined,
          summary: result.summary || undefined,
          responsibilities: result.responsibilities?.length ? result.responsibilities : undefined,
          requirements: result.requirements?.length ? result.requirements : undefined,
          niceToHave: result.nice_to_have?.length ? result.nice_to_have : undefined,
          portfolioRequirement: result.portfolio_requirement || undefined,
          benefitsRemote: result.benefits_remote?.length ? result.benefits_remote : undefined,
          benefitsInPerson: result.benefits_inperson?.length ? result.benefits_inperson : undefined,
          workCulture: result.work_culture?.length ? result.work_culture : undefined,
          status,
